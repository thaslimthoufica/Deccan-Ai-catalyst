  ...
  useEffect(() => {
    async function boot() {
      ...
      try {
        ...
        setError('Could not initialize assessment. Ensure resume and JD are uploaded first.');
      } finally {
        setLoading(false);
      }
    }
  ...
  return (
    <div className="space-y-4 max-w-5xl">
      <div className="card">
        ...
        {!loading && !assessment && !error && <p className="text-slate-600 mt-3">Upload resume and JD first.</p>}
